...
public enum FontColor {
	...
	private static ArrayList<FontColor> chatColors = new ArrayList<FontColor>();
	
	public static final String COLOR_CODE = "§";
	
	private FontColor(String identifier, int red, int green, int blue) {
	...
	public static FontColor getChatColor(String check) {
		for (int i = 0; i < chatColors.size(); i++) {
